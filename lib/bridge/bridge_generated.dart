...
abstract class Native {
  ...
  /// 获取redis 占用的内存
  Future<String> getRedisMemory({dynamic hint});
...
class NativeImpl implements Native {
  ...
  Future<String> getRedisMemory({dynamic hint}) {
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_get_redis_memory(port_),
      parseSuccessData: _wire2api_String,
      constMeta: kGetRedisMemoryConstMeta,
      argValues: [],
      hint: hint,
    ));
  }
...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  void wire_get_redis_memory(
    int port_,
  ) {
    return _wire_get_redis_memory(
      port_,
    );
  }

  late final _wire_get_redis_memoryPtr =
